...
✔ Backend: Spring Boot | Spring MVC | Spring Data JPA | Hibernate | JDBC  
...
✔ Spring Core | Spring Boot | Spring MVC | Spring Data JPA | Hibernate | JDBC | Servlets | JSP
🧠 Languages
...
Manual | Functional | Regression | SDLC | STLC | Agile

🛠 Tools

Git | Jira | IntelliJ IDEA | Eclipse | Visual Studio Code | SQL*Plus

💬 Strengths

Analytical Thinking | Excellent Communication | Interpersonal Skills | Team Collaboration
